  ...
  return (
    <div className="max-w-[575px] flex justify-between flex-col">
      <div>
        ...
        <h1 className="text-[#fafafa] text-[56px] font-normal tracking-[-1.12px] mt-[10px] leading-tight">
          Manage Your{' '}
          <span className="text-[springgreen] underline">Finances</span>{' '}
          Masterfully!
        </h1>
        <p className="text-[#fafafa66] text-[16px] font-light tracking-[-0.32px] mt-[20px] max-w-[533px]">
